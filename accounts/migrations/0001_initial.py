    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Administrator', 'Administrator'), ('Member', 'Member'), ('Staff', 'Staff')], default='Member', max_length=25)),
                ('phone', models.IntegerField(default=741594863, unique=True)),
